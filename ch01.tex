...
When the computer sees \java{//}, it ignores everything from there until the end of the line.
...
The programmer writes source code in the file {\tt Hello.java} and (periodically) uses {\tt javac} to compile it.
If there are no errors, the compiler saves the corresponding byte code in the file {\tt Hello.class}.
...
\section{Displaying other messages}
...
However if you're interested in learning more about Java itself, Oracle maintains an official set of tutorials on their website: \url{https://docs.oracle.com/javase/tutorial/}.
