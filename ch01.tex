...
On one level you will be learning to write code, a useful skill by itself.
...
Not surprisingly, searching for ``computer'' on \url{images.google.com} displays rows and rows of these types of machines.
...
Each type of computer has its own design, but internally they all share the same type of {\bf hardware}.
...
Users generally see and interact with touchscreens, microphones, keyboards, and monitors, but it's the processors and memory that perform the actual computation.
Nowadays it's not uncommon, even for a smartphone, to have eight processors and four gigabytes (four billion cells) of memory.
...
The process continues until the subtasks are simple enough to be performed with the basic electronic circuits provided by the computer.
...
\href{https://www.toptal.com/developers/sorting-algorithms/}{Sorting-algorithms.com} provides animations and descriptions for eight of the most common ways.
...
It's possible to display multiple lines of output in just one line of code.
