...
\includegraphics[height=11em,alt={Photograph of a computer processor chip showing the integrated circuit components}]{figs/CPU.jpg}
\hspace{2em}
%https://commons.wikimedia.org/wiki/File:Memory_module_DDRAM_20-03-2006.jpg
\includegraphics[height=11em,alt={Photograph of a computer memory module showing the RAM chips and circuit board}]{figs/RAM.jpg}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Diagram showing the process of how interpreted languages are executed step by step}]{figs/interpreter.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Diagram showing the Java development process from source code compilation to byte code execution}]{figs/compiler.pdf}
