...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing two primitive variables: int number with value -2 and char symbol with value '!' stored directly in memory}]{figs/mem1.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a char array variable with an arrow pointing to an array containing the characters 'c', 'a', 't'}]{figs/mem2.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a String variable with an arrow pointing to a String object containing the characters 'd', 'o', 'g'}]{figs/mem3.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing two variables that are null, represented by boxes with no arrows pointing to any objects}]{figs/mem4.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram comparing null and empty string: str1 shows a box with no arrow (null), while str2 shows an arrow pointing to an empty String object}]{figs/nullempty.pdf}
