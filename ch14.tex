...
\begin{code}
public Card popCard() {
    int i = cards.size() - 1;     // from the end of the collection
    return popCard(i);
}
\end{code}
...
% TODO: Is this the first example of one instance method calling another with no `this`?
...
The \java{play} method invokes two helper methods, \java{searchForMatch} and \java{drawForMatch}.
