...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.75\textwidth,alt={UML class diagram showing inheritance relationships between Card, Hand, Deck, and Player classes, with composition arrows showing HAS-A relationships between classes}]{figs/uml1.png}
