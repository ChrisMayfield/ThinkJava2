...
This method modifies the \java{box} object it is invoked on.
...
A minus sign (\java{-}) would identify \java{private} attributes and methods, which we discuss in the next chapter.
...
%
%% TODO: Maybe change the previous discussion to say "can be used",
%% rather than "exists"
%
...
% ABD: At this point do we know about public/private access to attributes?
...
% ABD: I'm not sure I understand this second advantage:
And as we'll see later, it's easier to implement objects that allow their attributes to be changed.

% TODO: If we can't clarify the second advantage, we might have to revise the previous sentence

\section{StringBuilder Objects}

% TODO: When we resolve the flow of this chapter, we could use a smoother transition here.
...
The \StringBuilder} class also provides methods for inserting and deleting parts of strings efficiently.
