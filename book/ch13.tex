...
We first define a class to represent a deck of cards.
...
Here is the beginning of a \java{Deck} class that encapsulates an array of \java{Card}s:
...
Notice that \java{Deck} with a capital \java{D} is a class, and \java{deck} with a lowercase \java{d} is an object.
...
The constructor initializes \java{this.cards} with an empty \java{ArrayList} of \java{Card} objects.
...
The last method we need adds an entire deck (or subdeck) to the pile.
