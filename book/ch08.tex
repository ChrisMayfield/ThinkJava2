...
%TODO: What do you think of hyphenating "value-returning" throughout?
...
Yes you can, by multiplying by $n$.  Here's an implementation of \java{factorial} with the temporary variables removed:
...
%NOTE: We have already talked about decimal numbers, so I'm inclined
% to leave it unexplained here.
...
% NOTE: I would say this differently:  the written representation
% of numbers is made up of
% digits, regardless of the base.  Decimal uses 10 digits; binary
% uses 2.  

% So I think we can leave bits out of the discussion, and just talk
