...
We have to \java{Arrays} before we can use it.
And the output is:
...
%TODO: Smaller boxes for the references
...
At the end of the loop, \java{count} contains a histogram of the letters in \java{lower}.
