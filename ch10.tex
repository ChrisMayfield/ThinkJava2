...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a variable named blank with an arrow pointing to a Point object containing attributes x=3 and y=4}]{figs/reference.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a Rectangle object with attributes x=0, y=0, width=100, and height=200}]{figs/rectangle.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing the same Rectangle object after its x and y attributes have been updated to x=50 and y=100}]{figs/rectangle2.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing two variables box1 and box2 both pointing to the same Rectangle object, demonstrating aliasing}]{figs/aliasing.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing the same aliased Rectangle object after the grow method has modified its attributes to x=-50, y=-50, width=200, and height=300}]{figs/aliasing2.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={UML class diagrams showing Point class with attributes x:int, y:int and methods distance(), and Rectangle class with attributes x:int, y:int, width:int, height:int and methods translate(), grow()}]{figs/point-rect.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a variable that was previously pointing to a Point object, but now contains null, with no arrow pointing to any object}]{figs/reference3.pdf}
