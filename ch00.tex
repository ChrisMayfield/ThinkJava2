...
\item If you don't want to use Git at all, you can download the code in a ZIP archive using the {\sf Download ZIP} button on the GitHub page, or this link: \url{https://github.com/ChrisMayfield/ThinkJavaCode2/archive/master.zip}.
