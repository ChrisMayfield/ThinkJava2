...
Figure~\ref{fig.time2} is a memory diagram that shows these variables and their values.
...
The code for this chapter is in the {\tt ch11} directory of {\tt ThinkJava2Code}.
