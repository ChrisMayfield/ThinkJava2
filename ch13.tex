...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a Deck object with a cards array containing null references, representing an unpopulated deck}]{figs/deckobject.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a subdeck with low=0 and high=4, containing 5 cards that are aliased (shared) with the original deck}]{figs/subdeck.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={UML class diagram showing Deck class with private cards array attribute and public methods including constructors, print, shuffle, selectionSort, mergeSort, and subdeck}]{figs/deck.pdf}
