...
For example, if the starting value is 3, the resulting sequence is 3, 10, 5, 16, 8, 4, 2.
(The above code will not print 1, because the while loop terminates when n == 1.)
