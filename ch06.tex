...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=190pt,alt={Flowchart showing the execution flow of a while loop with condition check, loop body execution, and return to condition check}]{figs/while.pdf}
...
For example, if the starting value is 3, the resulting sequence is 3, 10, 5, 16, 8, 4, 2, (the above code will not print 1, because the while loop terminates when n == 1)
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=190pt,alt={Flowchart showing the execution flow of a for loop with initialization, condition check, loop body execution, and increment/decrement steps}]{figs/for.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing the string "banana" with character indices 0 through 5, illustrating how string methods access individual characters}]{figs/banana.pdf}
