...
We'll also take a closer look at \java{String} methods and solve some interesting problems.
...
Here is another \java{while} loop example that displays the numbers 1 to 5.
