...
The it calls \java{Thread.sleep} with a delay that depends on \java{rate}.
...
% TODO: If we decide to break this out as a mini-chapter, we could provide a more complete solution by doing some or all of the exercises below.
