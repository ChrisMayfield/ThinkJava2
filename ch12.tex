...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing an array of string references pointing to String objects containing "Clubs", "Diamonds", "Hearts", and "Spades"}]{figs/stringarray.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a Card array with 52 elements, all initially containing null references, representing an unpopulated deck of cards}]{figs/cardarray.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing a Card array where the first two elements point to Card objects (Ace of Clubs and 2 of Clubs), while the remaining elements still contain null references}]{figs/cardarray2.pdf}
