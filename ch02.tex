...
For example, the \java{int} type can store integers like {1} and \java{-5}, and the \java{char} type can store characters like \java{'A'} and \java{'z'}.
...
You can see the full list of keywords at \url{https://thinkjava.org/keywords}, but you don't have to memorize them.
...
The first line includes the name of the exception, \java{ArithmeticException}, and a message that indicates more specifically what happened, \java{/ by zero}.
