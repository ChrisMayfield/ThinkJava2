...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing two variables a and b with their values}]{figs/state.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Memory diagram showing three variables a, b, and c with their values}]{figs/state2.pdf}
