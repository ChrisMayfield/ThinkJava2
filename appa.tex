...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.95\textwidth,alt={Screenshot of DrJava IDE showing the Hello World program being edited in the main editor pane with Java syntax highlighting}]{figs/drjava-hello.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.95\textwidth,alt={Screenshot of DrJava IDE showing the Interactions pane at the bottom with variable declarations and logic expressions being tested interactively}]{figs/drjava-logic.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=4.5in,alt={Terminal/command line interface showing the process of compiling Hello.java with javac and running it with java, demonstrating the complete workflow from source code to execution}]{figs/terminal.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.95\textwidth,alt={Screenshot of the meld file comparison tool showing side-by-side comparison of expected output and actual output files, highlighting differences between them}]{figs/meld.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.95\textwidth,alt={Screenshot of DrJava debugger interface showing the call stack, breakpoints, and debugging controls, with execution paused on a specific line of code}]{figs/debugger.png}
