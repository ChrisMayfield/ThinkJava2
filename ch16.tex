...
Of course the answer is ``yes'', but our \java{Drawing} is currently based on \java{DrawablePolygon}.
...
There's just one problem: \java{DrawablePolygon} already extends \java{Polygon}, and classes may extend only one superclass.
...
% Is that true?  I thought they would have "default" protection.
...
We can change the definition of \java{DrawablePolygon} as follows:
...
The same is true for subclasses of \java{DrawablePolygon}.
