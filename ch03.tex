...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Diagram showing the structure of System.out.println with System class containing out variable of type PrintStream}]{figs/system.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=284pt,alt={Hierarchy diagram showing Java language elements from largest to smallest: packages containing classes, classes containing methods, methods containing statements, statements containing expressions, and expressions containing tokens}]{figs/package.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Diagram showing a stream of characters with an arrow pointing to the next character to be read by Scanner}]{figs/hopper1.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Diagram showing the state of the character stream after nextInt has read the numeric value}]{figs/hopper2.pdf}
