...
As we saw in Section~\ref{exception}, the error message includes the name of the exception, \java{MissingFormatArgumentException}, and an additional message, \verb"Format specifier '%d'".
