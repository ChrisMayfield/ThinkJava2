...
Unfortunately the compiler won't catch this kind of mistake, because it's within a legal Java statement.
...
In order words, it doesn't know what value to substitute for the \java{%d}.
...
But if \java{inch} is 1 and \java{cm} is 2.54, the resulting format string is \java{"\%d in = \%f cm\\n12.54"} after applying the \java{+} operators.
