...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Stack diagram showing the call stack with main method on top and printTime method below, illustrating method scope and variable visibility}]{figs/stack1.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[alt={Diagram showing the flow of data from main method to calculateArea method, with parameter radius receiving value 5.0 and return value 78.54 being assigned to variable area}]{figs/param.pdf}
