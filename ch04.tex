...
For example, Java Tutor (\url{http://thinkjava.org/javatutor}) allows you to step through an entire program, both forwards and backwards, and see the stack frames and variables at each step.
